...
export function RadioLyricsView({ lyricsOpen, setLyricsOpen }: RadioLyricsViewProps) {
  ...
  return (
    <ModalTransition
      ...
      panelZ={56}
      variant="bottom"
      panelClassName="fixed bottom-[calc(4rem+env(safe-area-inset-bottom))] left-3 right-3 max-h-[50vh] overflow-auto rounded-t-2xl border border-b-0 border-(--notion-border) bg-(--notion-bg) p-4 shadow-2xl md:bottom-[5.25rem] md:left-1/2 md:right-auto md:w-full md:max-w-md md:-translate-x-1/2"
    >
